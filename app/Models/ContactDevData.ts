import { ContactCardDataStructureInterface, Links } from "../interfaces/ContactDevDataInterface";
...
export const contactData: ContactCardDataStructureInterface = {
  title: "Contact Section",
  subtitles: {
    first: "Explore my qualifications, skills, and experience in detail",
    second: "Social networks",
  },
  description: "You can get in touch with me throug one of these social networks",
  links: [
    {
      url: CV_URL,
      Icon: PiFileTextThin,
